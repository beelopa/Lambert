function [Transfer_Matrix, L1, L2, L3] = ICRF2IVP(Time,Body_Count,EPH,Center)
%International Celestial Reference Frame to Invariable Reference Plane
% digits (16);
format long;
...
%% Equations:
%     u = @(M) G*M;                        %µ
%     fL = @(m,r,v) m * cross(r,v);        %% CHANGE: GOT RID OF MASS 
        fL1 = @(m,r,v) (r(2)*v(3)-r(3)*v(2));
        fL2 = @(m,r,v) (r(3)*v(1)-r(1)*v(3));
        fL3 = @(m,r,v) (r(1)*v(2)-r(2)*v(1));
